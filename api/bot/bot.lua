...
bot_token = "556081783:AAEhymDvjGHLSB-ahuIvZLQs_8O0Sdehue4" --> رو که در بات فادر ساختین جایگزین کنید api اینجا توکن ربات
send_api = "https://api.telegram.org/bot"..bot_token
sudo_id = 205549111 --> اینجا آیدی سودو اصلی رو جایگزین کنید
TiiGeRwmch = '@TiiGeRTeaM' --> یوزرنیم کانالتونو جایگزین کنید
TiiGeRwmby = '@Aashwm' --> یوزرنیم سودو اصلی رو جایگزین کنید
require('./bot/methods')
require('./bot/utils')
require('./libs/JSON')
...
function create_config( )
	...
	elseif not server_user:match("^root$") then
		TiiGeRTeaM = '/home/'..server_user..'/MaTaDoR/cli'
	end
