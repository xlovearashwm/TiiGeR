	...
	keyboard.inline_keyboard = {
	    {
            ...
            {text = "♣️ "..tostring(redis:get("TiiGeRDisLikes")), callback_data="/dislike:"..GP_id}
        },
        {
		...
		{
			{text = '❃ پشتیبانی ♻️', callback_data = '/TiiGeR:'..GP_id}
		},
		{
	...
	keyboard.inline_keyboard = {
	    {
            ...
            {text = "♣️ "..tostring(redis:get("TiiGeRDisLikes")), callback_data="/dislike:"..chatid}
        },
        {
		...
		{
			{text = '❃ پشتیبانی ♻️', callback_data = '/TiiGeR:'..chatid}
		},
		{
