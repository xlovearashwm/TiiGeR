...
tdcli.getInlineQueryResults(107705060, msg.to.id, 0, 0, ""..texth.."[ "..msg.to.title.."]("..linkgp..")", 0, inline_link_cb, nil)
 ...
 if not data[tostring(chat)]['rules'] then
   if not lang then
     rules = "ℹ️ The Default Rules :\n1⚠️ No Flood.\n2⚠️ No Spam.\n3⚠️ No Advertising.\n4⚠️ Try to stay on topic.\n5⚠️ Forbidden any racist, sexual, homophobic or gore content.\n➡️ Repeated failure to comply with these rules will cause ban."
    elseif lang then
       rules = "ℹ️ قوانین پپیشفرض:\n1⚠️ ارسال پیام مکرر ممنوع.\n2⚠️ اسپم ممنوع.\n3⚠️ تبلیغ ممنوع.\n4⚠️ سعی کنید از موضوع خارج نشید.\n5⚠️ هرنوع نژاد پرستی, شاخ بازی و پورنوگرافی ممنوع .\n➡️ از قوانین پیروی کنید, در صورت عدم رعایت قوانین اول اخطار و در صورت تکرار مسدود."
 end
        else
...
if ((matches[1]:lower() == "dev" ) or (matches[1] == "برنامه نویس" )) and is_mahdiroo(msg) then 
      tdcli.sendContact(msg.chat_id_, msg.id_, 0, 1, nil, 09030146152, 'arashwm', 'tiigerteam', 205549111)
end
--------------------------------
