...
chats = {}
plugins = {}
TiiGeRwm_sudo = 205549111 --> اینجا آیدی سودو اصلی رو جایگزین کنید
...
bot_id =  502774533 --> جایگزین کنید cli اینجام که آیدی ربات
helper_id =  556081783--> جایگزین کنید api آیدی ربات
TiiGeRwmch = '@TiiGeRTeaM' --> یوزرنیم کانالتونو جایگزین کنید
TiiGeRwmby = '@Arashwm' --> یوزرنیم خودتونو جایگزین کنید
TiiGeRwmbybot = '@Pvresanforoshbot'  --> اگه پیام رسان دارید یوزرنیم پیام رسانتو جایگزین کنید 
...
sudo_users = {556081783,502774533,205549111}, --> رو جایگزین کنید api و cli داخل آکولاد آیدی سودو اصلی و سودوهای دیگه (درصورت نیاز) و آیدی ربات
    admins = {},
    disabled_channels = {},
